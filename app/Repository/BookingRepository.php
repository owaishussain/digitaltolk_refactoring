...
class BookingRepository extends BaseRepository
{
     ...
     * @param Job $model
     */
    function __construct(Job $model, MailerInterface $mailer, BookingService $bookingService)
    {
    ...
    public function getAll(Request $request, $limit = null)
    {
        ...
        if ($cuser && $cuser->user_type == env('SUPERADMIN_ROLE_ID')) {
            $allJobs = $this->bookingService->getSuperAdminUsers($requestdata);
        } else {
            $allJobs = $this->bookingService->getAdminUsers($requestdata);
        }
